...
<html>
<head>
<title>:: Cetak Penjualan | Program Penjualan Optik</title>
<link href="../../css/styles_cetak.css" rel="stylesheet" type="text/css"></head>
<body>
<h2> PENJUALAN </h2>
<table width="450" border="0" cellspacing="1" cellpadding="4" class="table-print">
  <tr>
    ...
    <td width="10"><b>:</b></td>
    <td width="254" valign="top"><strong><?php echo $myData['kd_jual']; ?></strong></td>
  </tr>
  <tr>
...
<table class="table-list" width="700" border="0" cellspacing="1" cellpadding="2">
  ...
  <?php
	...
	$mySql ="SELECT penjualan_item.*, barang.nama_barang FROM penjualan_item
