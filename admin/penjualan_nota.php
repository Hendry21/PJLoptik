...
if(isset($_GET['noNota'])){
	...
	$mySql = "SELECT * FROM penjualan WHERE kd_jual='$noNota'";
...
<title>Cetak Nota Penjualan - Program Penjualan Optik</title>
...
<table class="table-list" width="430" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td height="87" colspan="4" align="center">
		<strong>PROGRAM TOKO OPTIK</strong><br />
        <strong>NPWP/ PKP : </strong>1.111111.11111<br />
        <strong>Tgl. Pengukuhan : </strong>01-10-2014 <br />
        Kota Sumedang </td>
  </tr>
  <tr>
    <td><strong>No Nota :</strong> <?php echo $kolomData['kd_jual']; ?></td>
...
$notaSql = "SELECT penjualan_item.*, barang.nama_barang FROM penjualan_item
			LEFT JOIN barang ON penjualan_item.kd_barang=barang.kd_barang 
			WHERE penjualan_item.kd_jual='$noNota'
...
?>
  <tr>
    ...
    <?php echo $notaData['nama_barang']; ?></td>
