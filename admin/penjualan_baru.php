...
if(isset($_POST['btnSimpan']))
{
	...
	$dataHargaJual=$tmpData['harga_jual']; 
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
   <table class="table table-striped table-bordered table-condensed">
    ...
    <tr>
      ...
      <td width="72%"><input name="txtNomor" value="<?php echo $kd_jual; ?>" size="23" maxlength="20" readonly/></td>
    </tr>
    <tr>
	...
	<tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="txtKode" value="<?php echo $dataKode; ?>" size="13" maxlength="13"  id="anime" type="text" />
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="txtMerk" value="<?php echo $dataMerk; ?>" size="40" maxlength="40" readonly /></td>
    </tr>
    <tr>
      <td><strong>Jenis Ukuran </strong></td>
      <td><strong>:</strong></td>
      <td><input name="txtJenis" value="<?php echo $dataJenis; ?>" size="5" maxlength="40" readonly />
      <input name="txtUkuran" value="<?php echo $dataUkuran; ?>" size="5" maxlength="40" readonly /></td>
    </tr>
    <tr>
      <td><b>Harga Jual (Rp)</b></td>
      <td><b>:</b></td>
      <td><b>
        <input name="txtHarga" value="<?php echo $dataHargaJual; ?>" size="40" maxlength="40" readonly />
Jumlah :
...
?>
    <tr>
      ...
      <td><a href="?open=Tmp-Hapus&id=<?php echo $tmpData['id'];?>" target="_self">Delete</a></td>
    </tr>
<?php } ?>
    <tr>
