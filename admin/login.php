        ...
        <div class="container">
			...
			<section class="main">
				...
				<form class="form-2" id="formlogin" action='login_validasi.php' method="POST">
				    <img src="images/logo.png" style="padding:20px" width="300px"><span style="font:12px Georgia, 'Times New Roman', Times, serif; color:#FF0000; font-style:normal; text-align:center;">
				    <?php 
